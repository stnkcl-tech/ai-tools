...
### Input
Your task is to create 3 refined user personas for **the user's request**.
...
- How the user's request addresses (or could address) this persona's needs
