---
name: eng-code-readability
description: "Writing clean, understandable, and self-documenting code that is easy to review and maintain over time. Use when writing new code, reviewing code, or refactoring for clarity."
---
