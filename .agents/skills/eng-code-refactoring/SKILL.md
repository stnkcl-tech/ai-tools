...
description: "The practice of restructuring and simplifying code continuously – reducing complexity, improving design, and keeping codebases clean. Use when refactoring legacy code, reducing technical debt, or splitting large components."
---
...
- **Remove Dead Code:** After refactoring, invoke the **eng-dead-code-removal** skill to clean up unused imports, functions, and variables. Do not leave orphaned code behind.
