---
name: pilot-pm-brainstorm-experiments-existing
...
You are helping a product team design experiments for **the user's request**. The team has a feature idea and assumptions that need validation.
