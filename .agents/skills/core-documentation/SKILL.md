...
description: "Communicating the intended behavior and context of code through clear documentation and comments, and sharing knowledge with the team. Use when writing READMEs, adding code comments, maintaining project docs, or any task involving written communication of intent."
---

# Documentation & Knowledge Sharing

Effective developers write code and documentation. This includes inline comments explaining non-obvious code and higher-level docs that describe modules and systems. Good documentation ensures that knowledge is shared, onboarding is easier, and future maintainers understand the rationale behind decisions. In collaborative environments, this skill is invaluable for team velocity.
...
- **Deep Technical Docs:** For OpenAPI specs, architecture docs, ADRs, changelogs, and migration guides, invoke the **eng-documentation** skill.
