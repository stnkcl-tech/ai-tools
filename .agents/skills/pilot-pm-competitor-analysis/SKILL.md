---
name: pilot-pm-competitor-analysis
...
### Input
Your task is to analyze the competitive landscape for **the user's request** in the **[market/industry segment]** (if specified).
...
1. **Market Scoping**: Define the market, industry, and addressable customer base for the user's request
...
5. **Differentiation Mapping**: Identify gaps, overlaps, and opportunities for the user's request to differentiate
...
- Recommended competitive positioning for the user's request
