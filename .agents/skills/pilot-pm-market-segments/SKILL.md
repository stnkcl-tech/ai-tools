...
### Input
Your task is to identify and analyze potential customer segments for **the user's request**.
...
1. **Market Exploration**: Consider the full addressable market for the user's request
