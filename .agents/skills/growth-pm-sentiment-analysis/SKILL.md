---
name: growth-pm-sentiment-analysis
...
### Input
Your task is to analyze user feedback data for **the user's request** and identify market segments with associated sentiment insights.
...
- What this segment loves about the user's request
...
- How well the user's request serves this segment's needs
